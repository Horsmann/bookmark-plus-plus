...
public class AddTreeNodesToExistingBookmark
	implements TreeCommand
{
	...
	public AddTreeNodesToExistingBookmark(BookmarkView viewer, BMNode bookmark,
			BMNode node, boolean keepSourceNode)
	{
		this.viewer = viewer;
