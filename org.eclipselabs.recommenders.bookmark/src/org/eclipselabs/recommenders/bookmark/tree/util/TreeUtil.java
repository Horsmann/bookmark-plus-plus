...
public class TreeUtil
{
	...
	{
		return new TreeNode("New Bookmark", true, false);
	}
	...
	{
		BMNode tmpChild = new TreeNode(value, false, true);
		...
		while (true) {
			...
			tmpParent = new TreeNode(element, false, false);
			...
			boolean inclusiveBookmark)
	{
		...
		BMNode newNode = new TreeNode(value, isBookmark, showInFlatModus);
