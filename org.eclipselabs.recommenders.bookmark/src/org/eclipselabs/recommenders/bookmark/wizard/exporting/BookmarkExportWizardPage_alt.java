...
public class BookmarkExportWizardPage_alt extends WizardPage implements BookmarkCommandInvoker {
    ...
    protected BookmarkExportWizardPage_alt(String pageName) {
    ...
    private class ButtonMouseDownListener implements Listener {
        private final BookmarkExportWizardPage_alt exportPage;

        public ButtonMouseDownListener(BookmarkExportWizardPage_alt exportPage) {
