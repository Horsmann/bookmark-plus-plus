...
//						Point pt = table.toDisplay(rect.x, rect.y);
		...
		combo.addListener(SWT.Dispose, tableListener);
		combo.addListener(SWT.KeyDown, tableListener);
		combo.addListener(SWT.MouseMove, tableListener);
		combo.addListener(SWT.MouseHover, tableListener);
		shell.open();
